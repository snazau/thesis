...
if __name__ == "__main__":
    ...
    subject_dataset = datasets.datasets_static.SubjectRandomDataset(subject_eeg_path, subject_seizures, samples_num=100, sample_duration=10, normalization='meanstd', data_type='raw')
